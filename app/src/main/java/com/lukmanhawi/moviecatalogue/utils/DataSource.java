...
public class DataSource {
    ...
    public static List<TVResponse> generateDummyTvShows() {

        List<TVResponse> tvshows = new ArrayList<>();

        tvshows.add(new TVResponse(
                "1412",
                "Arrow",
                "2012-10-10",
    ...
    public static TVResponse generateDummyTvShowsById(String id) {
        TVResponse tvshowResponse = null;
        List<TVResponse> tvShows = generateDummyTvShows();

        for (TVResponse response : tvShows){
